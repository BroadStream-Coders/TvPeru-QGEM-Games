...
export const NORMAL_TEXT_IDS = optionIds("text-normal");
export const CORRECT_TEXT_IDS = optionIds("text-correct");
export const INCORRECT_TEXT_IDS = optionIds("text-incorrect");
