...
export function LaSabesBehavior() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < OPTION_COUNT; i++) {
      ...
      patchComponent(NORMAL_TEXT_IDS[i], "text", { text: option });
      patchComponent(CORRECT_TEXT_IDS[i], "text", { text: option });
      patchComponent(INCORRECT_TEXT_IDS[i], "text", { text: option });
